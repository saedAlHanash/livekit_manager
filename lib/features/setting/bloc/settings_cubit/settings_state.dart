...
class SettingsInitial extends AbstractState<List<Setting>> {
  ...
  factory SettingsInitial.initial() {
    return  SettingsInitial(
      result: [],
      createUpdateRequest: CreateSettingRequest.fromJson({}),
    );
  }

  CreateSettingRequest get cRequest => createUpdateRequest;
