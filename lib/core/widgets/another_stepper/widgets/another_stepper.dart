...
import 'package:livekit_manager/core/widgets/another_stepper/widgets/vertical_stepper.dart';
...
class AnotherStepper extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    var crossAxisAlign =
        stepperDirection == Axis.horizontal ? CrossAxisAlignment.end : CrossAxisAlignment.start;
    if (inverted) {
