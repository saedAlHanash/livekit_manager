  ...
  void paint(Canvas canvas, Size size) {
    ...
    path_0.arcToPoint(Offset(size.width * -28.02632, size.height * -13.35265),
        radius: Radius.elliptical(
            size.width * 0.02927485, size.height * 0.01528547),
        rotation: 0,
        largeArc: false,
        clockwise: true);
    ...
    path_0.arcToPoint(Offset(size.width * -27.97657, size.height * -13.63489),
        radius: Radius.elliptical(
            size.width * 0.07217836, size.height * 0.03768697),
        rotation: 0,
        largeArc: false,
        clockwise: false);
    path_0.arcToPoint(Offset(size.width * -27.95594, size.height * -13.65934),
        radius: Radius.elliptical(
            size.width * 0.06391228, size.height * 0.03337094),
        rotation: 0,
        largeArc: false,
        clockwise: false);
    path_0.cubicTo(
    ...
    path_0.arcToPoint(Offset(size.width * -27.07894, size.height * -14.29463),
        radius: Radius.elliptical(
            size.width * 0.02927193, size.height * 0.01528395),
        rotation: 0,
        largeArc: false,
        clockwise: true);
    ...
    path_0.arcToPoint(Offset(size.width * -27.12868, size.height * -13.68379),
        radius: Radius.elliptical(
            size.width * 0.07216959, size.height * 0.03768239),
        rotation: 0,
        largeArc: false,
        clockwise: false);
    path_0.arcToPoint(Offset(size.width * -27.14932, size.height * -13.65934),
        radius: Radius.elliptical(
            size.width * 0.06391520, size.height * 0.03337247),
        rotation: 0,
        largeArc: false,
        clockwise: false);
    path_0.cubicTo(
