...
//             const Text("You can't record the screen", style: TextStyle(fontSize: 16)),
//             const SizedBox(height: 24),
//             ElevatedButton(onPressed: onCancel, child: const Text('Close')),
//           ],
//         ),
//       ),
//     );
